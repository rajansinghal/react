...
var config = {
  ...
  module : {
    loaders : [
      {
        test : /\.js?/,  //[rajan] take all the js file
        include : APP_DIR,
        loaders: [ "babel-loader"]
        //[rajan] .babelrc file will be used , to load bable compile which will convert ES6 jsx -> ES5 and become the part of final bundle
      },
